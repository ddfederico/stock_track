...
CREATE TABLE stock_mentions (
    ...
    CONSTRAINT fk_mention_stock FOREIGN KEY (stock_id) REFERENCES stocks (id)
);

CREATE INDEX ON stock_mentions (stock_id, dt DESC);
SELECT create_hypertable('stock_mentions', 'dt');
